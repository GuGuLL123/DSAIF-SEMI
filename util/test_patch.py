...
def var_all_case(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4, dataset_name="LA"):
    if dataset_name == "LA":
        with open('/data/ylgu/Medical/Semi_medical_data/LA_DATASET/data/test.list', 'r') as f:
            image_list = f.readlines()
        image_list = ["/data/ylgu/Medical/Semi_medical_data/LA_DATASET/data/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
    elif dataset_name == "Pancreas_CT":
        with open('/data/ylgu/Medical/Semi_medical_data/Pancreas_CT/data/test.list', 'r') as f:
            image_list = f.readlines()
        image_list = ["/data/ylgu/Medical/Semi_medical_data/Pancreas_CT/data/Pancreas_h5/" + item.replace('\n', '') + "_norm.h5" for item in image_list]
...
def var_all_case_inverse(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4, dataset_name="LA"):
    if dataset_name == "LA":
        with open('/data/ylgu/Medical/Semi_medical_data/LA_DATASET/data/test.list', 'r') as f:
            image_list = f.readlines()
        image_list = ["/data/ylgu/Medical/Semi_medical_data/LA_DATASET/data/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
...
def test_all_case(num_outputs, model, image_list, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4, preproc_fn=None, metric_detail=1, nms=0,up_down_inverse=0):
